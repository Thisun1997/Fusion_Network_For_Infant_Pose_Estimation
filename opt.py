...
def parseArgs(if_redef=True):
    ...
    # -- env settings
    parser.add_argument('--ds_fd', default='/content/drive/Shareddrives/TechFlow_FYP/datasets',
    ...
    parser.add_argument('--batch_size_pGPU', default=64, type=int, help='batch size per gpu')
    ...
    parser.add_argument('--n_thread', default=2, type=int, help='how many threads')
    ...
    # -- fuse settings
    parser.add_argument('--fuse_stage', default='', help='fuse stage of the HRNet')
    parser.add_argument('--fuse_type', default='', help='fuse type')
    # parser.add_argument('--weights', nargs='+', default=[], help='weights for fusion modalities')
...
def aug_opts(opts):
    ...
    nmT = '_'.join([nmT, modStr, covStr, suffix_train, opts.suffix_exp_train, str(opts.fuse_stage), opts.fuse_type, "weighted"])  # ds+ ptn_suffix+ exp_suffix
