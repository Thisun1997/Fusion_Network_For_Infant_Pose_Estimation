  ...
  with torch.no_grad():
    ...
    for i, inp_dct in enumerate(loader):
      ...
      if opts.if_flipTest:
        ...
        outputs_flipped=outputs_flipped["output"]
...
def main():
  ...
  # get model
  model = get_pose_net(in_ch=opts.input_nc, out_ch=n_jt, fuse_stage=opts.fuse_stage, fuse_type=opts.fuse_type, mod_src=opts.mod_src)      # why call it get c
